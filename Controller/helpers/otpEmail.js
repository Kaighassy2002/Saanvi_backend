...
async function sendPasswordResetOtpEmail({ to, otp, expiresInMinutes }) {
  ...
  await transporter.sendMail({
    from,
    to,
    subject: 'SAANVI password reset OTP',
    text: `Your SAANVI password reset OTP is ${otp}. It expires in ${expiresInMinutes} minutes. If you did not request this, ignore this email.`,
    html: `
      <div style="font-family:Arial,sans-serif;line-height:1.5;color:#222">
        <h2 style="margin:0 0 12px;">Reset your SAANVI password</h2>
